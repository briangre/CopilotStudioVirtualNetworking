...
- Connector actions can be invoked from Power Automate flows, Power Apps, or Copilot Studio agents.
...
3. Add the connector to a simple Power Automate flow and run it end-to-end.
