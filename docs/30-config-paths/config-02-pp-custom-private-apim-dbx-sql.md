...
- [ ] Entra ID app registration for Power Platform → APIM auth and a separate one (or same) for APIM → Databricks.
...
4. Test from the APIM test console — expect HTTP 200 from the mcpsql endpoint.
